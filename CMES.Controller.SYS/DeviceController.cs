...
namespace CMES.Controller.SYS
{
    public class DeviceController
    {
        ...
        /// <returns></returns>
        public String GetDeviceInfoToJson(string DeviceName, string DeviceNumber)
        {
            shebeiguanlijichuxinxi_TableEntity Device = new shebeiguanlijichuxinxi_TableEntity();
            List<shebeiguanlijichuxinxi_TableEntity> lists = new List<shebeiguanlijichuxinxi_TableEntity>();
            ...
            string mearResult = HttpHelper.DOPOST("Device", "Device/PostDeviceInfo", listpair);//Api未开启，报异常
